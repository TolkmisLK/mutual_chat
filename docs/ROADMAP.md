...
3. Two-user encrypted messages, invites, reconnect, duplicate-send behavior and explicit backward pagination passed their recorded gates. Pagination currently stops at 1,000 rendered messages; full timeline-window navigation, unread counts, search, redaction controls and safe authenticated media remain.
